(function(wHandle, wjQuery) {
    ...
    function drawStats() {
        ...
        var rows = [
            `(${stats.info.mode})-(${stats.info.playersTotal}/${stats.info.playersLimit})`,
        ...
        ctx.font = "14px Ubuntu";
        ctx.fillStyle = document.getElementById('othercolor').value;
    ...
    function drawLeaderboard() {
        ...
        if (!settings.showNames || leaderboard.items.length === 0)
            return leaderboard.visible = true;
        ...
        ctx.fillText("xAgar.io", 100 - ctx.measureText("xAgar.io").width / 2, 40);
    ...
    function drawMinimap() {
        ...
        mainCtx.fillStyle = document.getElementById('mapcolor').value;
	...
	function drawBorders() {
        ...
        mainCtx.strokeStyle = document.getElementById('boco').value;
    ...
    function drawGame() {
		...
		mainCtx.fillStyle = elementStyle.backgroundColor;
        ...
        var height = 2;
        mainCtx.fillStyle = document.getElementById('othercolor').value;
